...
```json
{
  ...
  "side": "1girl, 22 years old, ...（侧面可见特征，包含面部轮廓）",
  "back": "1girl, 22 years old, ...（背面可见特征，包含后脑发型）"
}
```

视角规则（【重要】所有视角必须保留核心面部特征以确保人物一致性）：
- front：包含面部特征、表情、发型正面、全身服装、配饰
- side：侧面轮廓、鼻梁/下巴轮廓、发型侧面、体型剪影、服装侧面。**必须包含年龄、性别、肤色、胡须/胡茬等辨识特征**
- back：后脑勺/发型背面、背部、体型背面、服装背面。**必须包含年龄、性别、发型背面、体型特征**
